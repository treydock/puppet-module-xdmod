...
class xdmod::config {
  ...
  xdmod_portal_setting { 'logger/password': value => $xdmod::database_password }
  ...
  xdmod_portal_setting { 'database/password': value => $xdmod::database_password }
  ...
  xdmod_portal_setting { 'datawarehouse/password': value => $xdmod::database_password }
  ...
  xdmod_portal_setting { 'shredder/password': value => $xdmod::database_password }
  ...
  xdmod_portal_setting { 'hpcdb/password': value => $xdmod::database_password }
