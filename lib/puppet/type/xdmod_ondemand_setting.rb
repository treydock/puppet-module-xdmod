...
Puppet::Type.newtype(:xdmod_ondemand_setting) do
  ensurable

  newparam(:name, namevar: true) do
    desc 'Section/setting name to manage from ondemand.ini'
    # namevar should be of the form section/setting
    validate do |value|
      unless value =~ %r{\S+/\S+}
        raise("Invalid xdmod_ondemand_setting #{value}, entries should be in the form of section/setting.")
      end
    end
  end
